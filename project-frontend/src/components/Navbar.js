...
export default function Navbar(props){
    ...
    return (
        <nav className="navbar--div">
            <a href="#">
                <img alt="" className="navbar--logo" src="https://logos-world.net/wp-content/uploads/2021/03/Yapi-Kredi-Emblem.png" />
            </a> 
            <div className="navbar--dropdown-room">
                <button className="navbar--dropdown-room-button">{roomName} <MdKeyboardArrowDown /> </button>
            ...
            <ChangeUsernamePopup trigger={changeUsernamePopup} setTrigger={setChangeUsernamePopup}/>
        </nav>
    );
}